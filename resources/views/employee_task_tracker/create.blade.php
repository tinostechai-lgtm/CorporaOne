...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['route' => 'employee.task.tracker.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <span class="text-danger">*</span>
                            {{ Form::date('due_date', date('Y-m-d', strtotime('+7 days')), ['class' => 'form-control', 'required' => true]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('priority', [
                                ...
                                'high' => 'High',
                                'urgent' => 'Urgent'
                            ], 'medium', ['class' => 'form-control', 'required' => true]) }}
                        </div>
                    </div>
