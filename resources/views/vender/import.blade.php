...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            <a href="{{asset(Storage::url('uploads/sample')).'/sample-vendor.csv'}}" class="btn btn-sm btn-primary" download="">
        ...
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                ...
                <input type="hidden" class="form-control" name="table" id="table" value="venders">
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <a href="" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Venders CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
