...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('assets/images/13.png')}}" type="image/x-icon" />
...
<nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
    <div class="container">
        <a class="navbar-brand bg-transparent" href="">
                ...
                <img src="{{asset('assets/images/13.png')}}" alt="logo" width="40%"/>
            ...
            <div class="col-lg-2">
                <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
                    ...
                    @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' )
                        ...
                        <img src="{{asset('assets/images/13.png')}}"
                             alt="" class="img-fluid ">
                    @else
        ...
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                    {{__(' All In One Business CorporaOne With Project, Account, HRM, CRM')}}
                </h2>
                <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                    Use these awesome forms to login or create new account in your
                    project for free.
