...
<head>
    ...
    <!--title-->
    <title>Quiety - Customer Relationship - Software & IT Solutions HTML Template</title>
...
<body>
    ...
    <div id="preloader" class="bg-light-subtle">
        <div class="preloader-wrap">
            <img src="asset/img/favicon.png" alt="logo" class="img-fluid preloader-icon">
    ...
    <div class="main-wrapper bg-soft-blue">
            ...
            <nav class="navbar navbar-expand-xl navbar-light sticky-header">
                ...
                ></i>
                            ...
                            <li class="nav-item dropdown">
                              ...
                              <i class="flaticon-pen-tool"></i>
                                        ...
                                        <div class="dropdown-grid-item last-item bg-light-subtle radius-right-side">
                                            <a href="#">
                                                <img src="assets/img/feature-img3.jpg" alt="add" class="img-fluid rounded-custom" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block">
                        ...
                        <a href="request-demo.html" class="btn crm-primary-btn">Get Started</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="action-btns mt-4 ps-3">
                        <a href="login.html" class="btn crm-secondary-btn me-2">Sign In</a>
                        <a href="request-demo.html" class="btn crm-primary-btn">Get Started</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-5 col-lg-6">
                        <div class="crm-hero-content position-relative z-1">
                            ...
                            <h1 class="display-2 mb-0">Customer <span class="d-inline-block d-lg-block">Relationship</span>Management</h1>
                            ...
                            <div class="crm-hero-bottom mt-60">
                                ...
                                <form class="crm-hero-form d-flex align-items-center">
                                    ...
                                    <button type="submit" class="crm-submit-btn">Subscribe</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <!--brand section start-->
        <section class="crm-brand">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center">
                            <h4 class="mb-0 fw-semibold clr-text">Trusted by More than 80 Million Users Globally</h4>
                        </div>
                    </div>
                </div>
                <div class="crm-brands-row mt-4">
                    <div class="crm-brand-item">
                        <img src="assets/img/icons/lattice-gray.png" alt="lattice" class="gray img-fluid">
                        <img src="assets/img/icons/lattice-black.png" alt="lattice" class="black img-fluid">
                    </div>
                    <div class="crm-brand-item">
                        <img src="assets/img/icons/northwest-gray.png" alt="northwest" class="gray img-fluid">
                        <img src="assets/img/icons/northwest-black.png" alt="northwest" class="black img-fluid">
                    </div>
                    <div class="crm-brand-item">
                        <img src="assets/img/icons/hellosign-gray.png" alt="hellosign" class="gray img-fluid">
                        <img src="assets/img/icons/hellosign-black.png" alt="hellosign" class="black img-fluid">
                    </div>
                    <div class="crm-brand-item">
                        <img src="assets/img/icons/getaround-gray.png" alt="hellosign" class="gray img-fluid">
                        <img src="assets/img/icons/getaround-black.png" alt="hellosign" class="black img-fluid">
                    </div>
                    <div class="crm-brand-item">
                        <img src="assets/img/icons/lattice-gray.png" alt="lattice" class="gray img-fluid">
                        <img src="assets/img/icons/lattice-black.png" alt="lattice" class="black img-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="crm-title text-center">
                            <span class="crm-subtitle">Why Choose Us <img src="assets/img/shape/arrow-red.png"
                                   alt="arrow"></span>
                                ...
                                <div class="col-xl-12">
                                    <div class="crm-about-content-box crm-bg-yellow-light rounded position-relative z-1 overflow-hidden">
                                        <div class="crm-content-wrapper">
                                            ...
                                            <a href="#" class="read-more-link">Explore More <i
        ...
        <section class="crm-support-area pt-60 pb-60 bg-white">
            <div class="container">
                <div class="crm-support-box position-relative z-1">
                    <div class="row align-items-center g-5 g-xl-3">
                        <div class="col-xl-6">
                            <div class="crm-title">
                                <span class="crm-subtitle">CRM Support <img src="assets/img/shape/arrow-red.png"
                                       alt="arrow"
                                       class="ms-1"></span>
                                <h2 class="text-white mb-0">See where your efforts are paying off and adjust your strategy</h2>
                                <a href="#" class="mt-40 btn crm-primary-btn">Explore More</a>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                            <div class="crm-counter-box bg-white rounded">
                                                <span
                                                    class="icon-wrapper d-flex align-items-center justify-content-center crm-bg-blue-light rounded">
                                                  <svg width="24"
                                                       height="24"
                                                       viewBox="0 0 24 24"
                                                       fill="none"
                                                ...
                                                <h3 class="mt-3 mb-1"><span class="counter clr-text">55</span>k+</h3>
                                                <p class="mb-0">Users Globally</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="crm-counter-box bg-white rounded mb--40 ms-xl-2">
                                                <span
                                                    class="icon-wrapper d-flex align-items-center justify-content-center crm-bg-yellow-light rounded">
                                                  <svg width="16"
                                                       height="19"
                                                       viewBox="0 0 16 19"
                                                       fill="none"
                                                       xmlns="http://www.w3.org/2000/svg">
                                                      <path d="M4.453 19H0.0205207C0.00820829 19 0 18.9908 0 18.977V9.56437C0 9.54828 0.0123125 9.53449 0.026677 9.53449H4.453C4.46736 9.53449 4.47967 9.54828 4.47967 9.56437V18.9701C4.47967 18.9862 4.46941 19 4.453 19ZM10.2768 19H5.8443C5.83199 19 5.82378 18.9908 5.82378 18.977V0.0298886C5.82378 0.0137947 5.83609 0 5.85045 0H10.2768C10.2911 0 10.3034 0.0137947 10.3034 0.0298886V18.9701C10.3034 18.9862 10.2911 19 10.2768 19ZM15.9733 19H11.5408C11.5285 19 11.5203 18.9908 11.5203 18.977V4.00968C11.5203 3.99359 11.5326 3.97979 11.547 3.97979H15.9733C15.9877 3.97979 16 3.99359 16 4.00968V18.9701C16 18.9862 15.9877 19 15.9733 19Z"
                                                            fill="#FFC02D" />
                                                  </svg>
                                              </span>
                                                <h3 class="mt-3 mb-1"><span class="counter clr-text">175</span>k+</h3>
        ...
        </section> <!--support section end-->

        <!--service section start-->
        <section class="crm-service-section bg-white ptb-120">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7">
                        <div class="crm-title text-center">
                            <span class="crm-subtitle">Our Services<img src="assets/img/shape/arrow-red.png" alt="arrow" class="ms-2"></span>
                            <h2 class="mt-1 mb-3">What Do You Need Help?</h2>
                            <p class="mb-0">Bring in quality leads, nurture them, and turn them into happy, paying customers. you've had with them, and more—all in a single place.</p>
                        </div>
                    </div>
                </div>
                <div class="mt-5">
                    <div class="row g-4 justify-content-center">
                        <div class="col-xl-4 col-md-6">
                            <div class="crm-service-box rounded">
                                <span class="icon-wrapper d-flex align-items-center justify-content-center rounded">
                                  <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <path d="M23.4564 0.847656H2.54282C1.1403 0.847656 -0.000732422 1.98869 -0.000732422 3.39121V22.6091C-0.000732422 24.0117 1.1403 25.1527 2.54282 25.1527H23.4564C24.859 25.1527 26 24.0117 26 22.6091V3.39121C26 1.98869 24.859 0.847656 23.4564 0.847656ZM6.78205 23.457H2.54282C2.07531 23.457 1.69495 23.0766 1.69495 22.6091V9.32613H6.78205V23.457ZM24.3043 22.6091C24.3043 23.0766 23.9239 23.457 23.4564 23.457H8.47779V9.32613H24.3043V22.6091ZM24.3043 7.63044H1.69495V3.39121C1.69495 2.9237 2.07531 2.54334 2.54282 2.54334H23.4564C23.9239 2.54334 24.3043 2.9237 24.3043 3.39121V7.63044V7.63044Z" fill="#EF3D3D"/>
                                      <path d="M4.23849 5.93475C4.70676 5.93475 5.08636 5.55515 5.08636 5.08688C5.08636 4.61862 4.70676 4.23901 4.23849 4.23901C3.77023 4.23901 3.39062 4.61862 3.39062 5.08688C3.39062 5.55515 3.77023 5.93475 4.23849 5.93475Z" fill="#EF3D3D"/>
                                      <path d="M7.62985 5.93475C8.09811 5.93475 8.47772 5.55515 8.47772 5.08688C8.47772 4.61862 8.09811 4.23901 7.62985 4.23901C7.16159 4.23901 6.78198 4.61862 6.78198 5.08688C6.78198 5.55515 7.16159 5.93475 7.62985 5.93475Z" fill="#EF3D3D"/>
                                      <path d="M11.0211 5.93475C11.4894 5.93475 11.869 5.55515 11.869 5.08688C11.869 4.61862 11.4894 4.23901 11.0211 4.23901C10.5529 4.23901 10.1733 4.61862 10.1733 5.08688C10.1733 5.55515 10.5529 5.93475 11.0211 5.93475Z" fill="#EF3D3D"/>
                                      <path d="M21.7606 13.0001H11.0211C10.5529 13.0001 10.1733 13.3797 10.1733 13.848C10.1733 14.3162 10.5529 14.6959 11.0211 14.6959H21.7606C22.2288 14.6959 22.6084 14.3163 22.6084 13.848C22.6084 13.3798 22.2288 13.0001 21.7606 13.0001Z" fill="#EF3D3D"/>
                                      <path d="M21.7606 17.9971H11.0211C10.5529 17.9971 10.1733 18.3767 10.1733 18.8449C10.1733 19.3132 10.5529 19.6928 11.0211 19.6928H21.7606C22.2288 19.6928 22.6084 19.3132 22.6084 18.8449C22.6084 18.3767 22.2288 17.9971 21.7606 17.9971Z" fill="#EF3D3D"/>
                                  </svg>
                              </span>
                                <h5 class="mb-2 mt-4">CRM Plus</h5>
                                <p class="mb-4">Bring in quality leads, nurture them, and turn them and more—all in a single place.</p>
                                <a href="services.html" class="read-more-link">Explore More <i
                                  class="fa-solid fa-arrow-right-long ms-1"></i></a>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="crm-service-box rounded">
                                ...
                                <h5 class="mb-2 mt-4">Marketing Plus</h5>
                                <p class="mb-4">Bring in quality leads, nurture them, and turn them and more—all in a single place.</p>
                                <a href="services.html" class="read-more-link">Explore More <i
                                  class="fa-solid fa-arrow-right-long ms-1"></i></a>
                            </div>
                    ...
                    <p class="text-center crm-explore-text mt-40">Do You Want To explore More Bundle <a href="#" class="text-decoration-underline fw-bold">Just Click Here</a></p>
                </div>
            </div>
        </section> <!--service section end-->

        <!--crm htw section start-->
        <section class="crm-how-it-works position-relative z-1 bg-white">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-5 col-lg-7">
                        <div class="crm-title">
                            <span class="crm-subtitle">How It Work <img src="assets/img/shape/arrow-red.png" alt="arrow" class="ms-1"></span>
                            <h2 class="mb-3 text-white">Learn What Quiety Can <br class="d-none d-xxl-block">Do For You.</h2>
                            <p class="mb-0 text-white">Bring in quality leads, nurture them, and turn them into happy, paying customers. you've had with them, and more—all in a single place.</p>
                            <a href="#" class="btn crm-primary-btn mt-40">Explore More</a>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-7 col-lg-5">
                        <div class="crm-htw-slider swiper ms-lg-3 mt-4 mt-lg-0">
                            <div class="swiper-wrapper">
                                <div class="crm-htw-single bg-white text-center rounded swiper-slide">
                                    <img src="assets/img/crm/htw-1.png" alt="girl" class="img-fluid mb-30">
                                    <h6 class="mb-2">What is CRM?</h6>
                                    <p class="mb-4">Bring in quality leads, nurture them, in a single place.</p>
                                    <a href="#" class="read-more-link">Explore More <i
                                      class="fa-solid fa-arrow-right-long ms-1"></i></a>
                                </div>
                                <div class="crm-htw-single bg-white text-center rounded swiper-slide">
                                    <img src="assets/img/crm/htw-2.png" alt="girl" class="img-fluid mb-30">
                                    <h6 class="mb-2">Grow your Small Business</h6>
                                    <p class="mb-4">Bring in quality leads, nurture them, in a single place.</p>
                                    <a href="#" class="read-more-link">Explore More <i
                                      class="fa-solid fa-arrow-right-long ms-1"></i></a>
                                </div>
                            ...
                            <div class="pagination-wrapper">
                                <span class="crm_init_value slide_counter">01</span>
                                <div class="swiper-pagination"></div>
                                <span class="crm_total_value slide_counter">00</span>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
        </section> <!--crm htw section end-->
                ...
                <div class="row justify-content-between align-items-center g-4">
                    <div class="col-lg-6">
                        <div class="crm-appss-circle">
                            <img src="assets/img/crm/apps.png" alt="apps" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="crm-integration-content">
                            <div class="crm-title">
                                ...
                                <p>Objectively strategize e-business e-tailers after an expanded array of communities. Conveniently aggregate integrated best practices whereas resource sucking results. Appropriately network collaborative portals without progressive channels.</p>
                                <p>Bring in quality leads, nurture them, and turn them into happy, paying customers. Get a complete view of all customer data—personal details, all communication you've had with them, and more—all in a single place.</p>
                            </div>
        ...
        <!--pricing table start-->
        <section class="crm-pricing-section pt-120 crm-bg-yellow position-relative">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="crm-title text-center">
                            <span class="crm-subtitle">Pricing Table <img src="assets/img/shape/arrow-red.png"
                                   alt="arrow"
                                   class="ms-1"></span>
                            <h2 class="mb-3 clr-text">Explore the top Features</h2>
                    ...
                    <table class="table">
                        <tr>
                            <th class="crm-pricing-switch-wrapper position-relative">
                                ...
                                <div class="crm-pricing-switch">
                                    <button class="crm-monthly">Monthly</button>
                                    <span class="crm-switch">
                                      <input type="checkbox"
                                             class="crm-checkbox-switch"
                                             checked>
                                      <span class="crm-switch-dot"></span>
                                    </span>
                                    <button class="crm-yearly">Yearly</button>
                                </div>
                                <img src="assets/img/shape/arrow-shape.png" alt="arrow" class="arrow-shape">
                            </th>
                            <th class="text-center crm-package-wrapper">
                                <span class="title-sm">Standard</span>
                                <span class="crm-package-price crm_yearly_price">$14</span>
                                <span class="crm-package-price crm_monthly_price">$03</span>
                                <p class="mb-3 crm-package-subtitle">/user/month billed annually</p>
                                <a href="#" class="btn btn-sm crm-package-btn">Try For Free</a>
                            </th>
                            <th class="text-center crm-package-wrapper">
                                <span class="title-sm">Professional</span>
                                <span class="crm-package-price crm_yearly_price">$20</span>
                                <span class="crm-package-price crm_monthly_price">$04</span>
                                <p class="mb-3 crm-package-subtitle">/user/month billed annually</p>
                                <a href="#" class="btn btn-sm crm-package-btn">Try For Free</a>
                            </th>
                            <th class="text-center crm-package-wrapper">
                                <span class="title-sm">Enterprise</span>
                                <span class="crm-package-price crm_yearly_price">$40</span>
                                <span class="crm-package-price crm_monthly_price">$05</span>
                                <p class="mb-3 crm-package-subtitle">/user/month billed annually</p>
                                <a href="#" class="btn btn-sm crm-package-btn">Try For Free</a>
                            </th>
                            <th class="text-center crm-package-wrapper">
                                <span class="title-sm">Ultimate</span>
                                <span class="crm-package-price crm_yearly_price">$64</span>
                                <span class="crm-package-price crm_monthly_price">$06</span>
                                <p class="mb-3 crm-package-subtitle">/user/month billed annually</p>
                                <a href="#" class="btn btn-sm crm-package-btn">Try For Free</a>
                            </th>
                        </tr>
                ...
                <div class="crm_pricing_feature_accordion accordion bg-white" id="crm_pricing_accordion">
                    <div class="accordion-item border-0">
                        <div class="accordion-header bg-light-subtle">
                            <a href="#crm_ft_1" data-bs-toggle="collapse">Sales Force Automation</a>
                        </div>
                        <div class="accordion-collapse collapse show" id="crm_ft_1" data-bs-parent="#crm_pricing_accordion">
                            <div class="accordion-body p-0">
                                <div class="crm_pricing_feature_table table-responsive">
                                    <table class="table">
                                        <tr>
                                            <td class="crm_pricing_features_name">Basic Modules</td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Tasks, Calls, Events</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Advanced filters</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Multiple pipelines</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Scoring Rules</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Sales forecasting</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Email insights</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                        ...
                                        <tr>
                                            <td class="crm_pricing_features_name">Multiple Currencies</td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                                            <td class="crm_pricing_feature_check text-center"><i class="fas fa-check"></i></td>
                    ...
                    <div class="accordion-item border-0">
                        <div class="accordion-header bg-light-subtle">
                            <a href="#crm_ft_2" data-bs-toggle="collapse">Sales Force Automation</a>
                        </div>
                        <div class="accordion-collapse collapse" id="crm_ft_2" data-bs-parent="#crm_pricing_accordion">
                            <div class="accordion-body p-0">
                                <div class="crm_pricing_feature_table table-responsive">
                                    <table class="table">
                                        <tr>
                    ...
                    <div class="accordion-item border-0">
                        <div class="accordion-header bg-light-subtle">
                            <a href="#crm_ft_3" data-bs-toggle="collapse">Sales Force Automation</a>
                        </div>
                        <div class="accordion-collapse collapse" id="crm_ft_3" data-bs-parent="#crm_pricing_accordion">
                            <div class="accordion-body p-0">
                                <div class="crm_pricing_feature_table table-responsive">
                                    <table class="table">
                                        <tr>
                    ...
                    <div class="accordion-item border-0">
                        <div class="accordion-header bg-light-subtle">
                            <a href="#crm_ft_4" data-bs-toggle="collapse">Sales Force Automation</a>
                        </div>
                        <div class="accordion-collapse collapse" id="crm_ft_4" data-bs-parent="#crm_pricing_accordion">
                            <div class="accordion-body p-0">
                                <div class="crm_pricing_feature_table table-responsive">
                                    <table class="table">
                                        <tr>
        ...
        <section class="crm-feedback-section pb-40 overflow-hidden bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="crm-feedback-box rounded position-relative">
                            <div class="crm-feedback-slider swiper">
                                <div class="swiper-wrapper">
                                    <div class="crm-feedback-single swiper-slide text-center">
                            ...
                            <div class="crm-feedback-control-slider swiper">
                                <div class="swiper-wrapper">
                                    <div class="crm-feedback-control-thumb swiper-slide">
                    ...
                    <div class="col-lg-6">
                        <div class="crm-cr-content pe-3">
                            <div class="crm-title mb-5">
                                <span class="crm-subtitle">Integration Software <img src="assets/img/shape/arrow-red.png" alt="arrow" class="ms-1"></span>
                                <h2 class="mt-2 mb-3">Build Excellent Customer Relationships</h2>
                                <p class="mb-0">Bring in quality leads, nurture them, and turn them into happy, paying customers. Get a complete view of all customer data—personal details, all communication you've had with them, and more—all in a single place.</p>
                            </div>
        ...
        <section class="crm-cta-section ptb-80 crm-bg-yellow-light position-relative z-1">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <div class="crm-title text-center">
                            <span class="crm-subtitle">Get In Touch <img src="assets/img/shape/arrow-red.png"
                                   alt="arrow"
                                   class="ms-1"></span>
                            <h2 class="mt-2 mb-3 clr-text">Start selling smarter <br> better & faster</h2>
                            <p class="mb-0">Get a complete view of all customer data—personal details, all communication you've
                                had with </p>
                            <a href="#" class="btn crm-primary-btn mt-40">Sign up Free</a>
                        </div>
                    </div>
                </div>
            </div>
