...
<head>
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Corporaone') }}
...
<body class="{{ $themeColor }}">
    <div class="custom-login">
        <div class="login-bg-img">
            ...
            <!-- <img src="{{ asset('assets/images/auth/15.jpeg') }}" class="login-bg-1" style="height: 350px; width:350px; "> -->
            <!-- <img src="{{ asset('assets/images/auth/20742.jpg') }}" class="login-bg-2" style="height: 200px; width:200px;"> -->
                    ...
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="#">
                            @if ($setting['cust_darklayout'] == 'on')
                                ...
                                <img class="logo"
                                    src="{{ asset('assets/images/14.png') }}" alt="" loading="lazy" style="height:40px;"  />
                            @else
                                <img class="logo"
                                    src="{{ asset('assets/images/14.png') }}"
                                    alt="" loading="lazy" style="height:40px;"/>
                            @endif
                        </a>
