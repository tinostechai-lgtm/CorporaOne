...
@endpush
    ...
    <div class="card-header">
        <h5>Webhook Lead Integration</h5>
        <small class="text-muted">Used for Facebook, Instagram, Google Ads, Zapier, etc.</small>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Webhook Secret Token <span class="text-danger">*</span></label>
                    <input type="text" name="webhook_token" class="form-control" 
                           value="{{ settings('webhook_token') }}" 
                           placeholder="e.g. my-secret-2025-token" required>
                    <small class="text-muted">
                        Your webhook URL: <code class="bg-light p-1">{{ url('/webhook/leads') }}</code>
                    </small>
                </div>
            </div>
            <div class="col-md-4 text-center">
                <button type="button" class="btn btn-info btn-sm" onclick="generateToken()">
                    <i class="ti ti-refresh"></i> Generate New Token
                </button>
            </div>
        </div>
        ...
        <div class="form-group mt-3">
            ...
            <textarea name="webhook_notes" class="form-control" rows="2" 
                      placeholder="e.g. Used for Facebook & Instagram Lead Ads">{{ settings('webhook_notes') }}</textarea>
        </div>

        <div class="alert alert-info mt-3">
            <strong>How to use:</strong><br>
            • Paste this URL in Facebook/Instagram/Google Ads webhook settings<br>
            • Add header: <code>X-Webhook-Token: YOUR_TOKEN_HERE</code><br>
            • Leads will appear in CRM instantly!
        </div>
    </div>
</div>
...
function generateToken() {
    const token = 'webhook_' + Math.random().toString(36).substr(2, 9) + 
                  Date.now().toString(36);
    document.querySelector('input[name="webhook_token"]').value = token;
}
</script>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="me-2">
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label class="form-check-labe text-dark {{ isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == 'sandbox' ? 'active' : '' }}">
                                                                                            <input type="radio"
                                                     ...
                                                     <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingThirty-three">
                                                            <button class="accordion-button" type="button"
                                                                ...
                                                                <span class="d-flex align-items-center" for="khalti-payment">
                                                                    {{ __('Khalti') }}
                                                                </span>
                                                                <div class="d-flex align-items-center">
                                                                    <label class="form-check-label m-1"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="ozow-payment">
                                                            <button class="accordion-button" type="button"
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        <input type="hidden" name="ozow_payment_is_enabled"
                                                                            value="off">
                                                                        <input type="checkbox"
                                                                            class="form-check-input input-primary"
                                                        ...
                                                        <div id="ozow-payment-settings"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <label for="ozow_payment_mode" class="col-form-label">{{ __('Ozow Mode') }}</label>
                                                                        <div class="d-flex">
                                                                            <div class="me-2">
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label class="form-check-labe text-dark {{ isset($admin_payment_setting['ozow_payment_mode']) && $admin_payment_setting['ozow_payment_mode'] == 'sandbox' ? 'active' : '' }}">
                                                                                            <input type="radio"
                                                                                                name="ozow_payment_mode" value="sandbox"
                                                                                                class="form-check-input"
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                name="ozow_payment_mode" value="live"
                                                                                                class="form-check-input"
