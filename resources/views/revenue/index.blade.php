                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        @if(!empty($revenue->add_receipt))
                                            @php
                                                // Check if file exists in public/uploads/revenue
                                                $filePath = public_path('uploads/revenue/' . $revenue->add_receipt);
                                                $fileExists = file_exists($filePath);
                                                
                                                // Get the correct URL
                                                $fileUrl = asset('uploads/revenue/' . $revenue->add_receipt);
                                            @endphp
                                            
                                            @if($fileExists)
                                                <div class="d-flex gap-1">
                                                    <a class="bg-primary btn btn-sm align-items-center" href="{{ $fileUrl }}" download="">
                                                        <i class="ti ti-download text-white"></i>
                                                    </a>
                                                    <a href="{{ $fileUrl }}" class="bg-secondary btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{__('Preview')}}" target="_blank">
