    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(['route' => 'purchase-return.store', 'method' => 'POST', 'id' => 'purchase-return-form']) }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::select('supplier', $venders, null, [
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="text-danger">*</span>
                                {{ Form::date('return_date', date('Y-m-d'), [
                    ...
                    <div class="row">
                        <div class="col-md-12 text-end">
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="ti ti-device-floppy"></i> {{ __('Create Purchase Return') }}
                            </button>
                        </div>
                    </div>
    ...
    $('#add-item').on('click', function() {
        ...
        let html = `
            <tr id="item-row-${itemIndex}">
                <td>
                    <select name="items[${itemIndex}][product_id]" class="form-control product-select" onchange="selectProduct(${itemIndex})">
                        ${productOptions}
                    </select>
                    <input type="hidden" name="items[${itemIndex}][product_name]" class="product-name-${itemIndex}">
                </td>
                <td>
                    <input type="number" name="items[${itemIndex}][quantity]" class="form-control quantity-${itemIndex}" min="0.01" step="0.01" value="1" required onkeyup="calculateRow(${itemIndex})" onchange="calculateRow(${itemIndex})">
                </td>
                <td>
                    <input type="number" name="items[${itemIndex}][price]" class="form-control price-${itemIndex}" min="0" step="0.01" value="0" required onkeyup="calculateRow(${itemIndex})" onchange="calculateRow(${itemIndex})">
                </td>
                <td>
                    <input type="number" name="items[${itemIndex}][total]" class="form-control row-total-${itemIndex}" readonly>
                </td>
                <td class="text-center">
                    <button type="button" class="btn btn-sm btn-danger remove-item" data-index="${itemIndex}">
