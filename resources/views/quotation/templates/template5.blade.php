...
<div class="quotation-preview-main" id="boxes">
    <div class="quotation-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: {{ $color }};color:{{ $font_color }} ">{{__('quotation')}}</h3>
                ...
                <td class="text-right">
                    <img class="quotation-logo"  src="{{$img}}"
                         alt="">
                    <p>
    ...
    <div class="quotation-body">
        ...
        <table class=" quotation-summary" style="margin-top: 30px;">
