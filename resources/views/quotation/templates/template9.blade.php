...
<body>
    ...
    <div class="quotation-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
                            ...
                            <table class="no-space" style="width: 70%;">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::quotationNumberFormat($settings, $quotation->quotation_id) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>{{ __('Issue Date') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $quotation->quotation_date) }}</td>
                                    </tr>
        ...
        <div class="quotation-body" style="padding-right: 0;">
            <table class="add-border quotation-summary">
