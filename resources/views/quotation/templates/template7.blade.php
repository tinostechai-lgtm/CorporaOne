...
<div class="quotation-preview-main" id="boxes">
    <div class="quotation-header" style="border-top: 15px solid var(--theme-color); background: #f8f8f8;">
        <table>
            <tbody>
            <tr>
                <td>
    ...
    <div class="quotation-body" style="border-bottom: 15px solid var(--theme-color);">
        <table class="vertical-align-top">
            <tbody>
            <tr>
