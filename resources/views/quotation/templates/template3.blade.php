...
<div class="quotation-preview-main"  id="boxes">
    <div class="quotation-header" style="">
        <table class="vertical-align-top">
            <tbody>
                <tr>
                    <td>
                        <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: {{$color}};">{{__('quotation')}}</h3>
                    </td>
    ...
    <div class="quotation-body">
        ...
        <table class="quotation-summary" style="border-bottom:1px solid {{$color}};">
