                ...
                <div class="tab-pane fade" id="hrmpermission" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules = [
                            ...
                            'work report',           // For Work Report Submission
                            'face id attendance'     // For Face ID Attendance
                        ];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <!-- ===== WORK REPORT SPECIFIC PERMISSIONS ===== -->
                                                    @if($module === 'work report')
                                                        @if(in_array('submit '.$module,(array) $permissions))
                                                            ...
                                                            @endif
                                                        @endif
                                                        @if(in_array('review '.$module,(array) $permissions))
                                                            @if($key = array_search('review '.$module,$permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input hrm_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                    {{Form::label('permission'.$key,'Review',['class'=>'custom-control-label'])}}<br>
                                                                </div>
                                                            @endif
                                                        @endif
                                                    @endif
                                                    <!-- ===== END WORK REPORT PERMISSIONS ===== -->
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
