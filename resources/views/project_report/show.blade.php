                                            ...
                                            <tr>
                                                ...
                                                <td class="border-0">
                                                    ...
                                                    @if($project->status == 'in_progress')
                                                        <div class="badge status_badge bg-primary p-2 px-3 rounded"> {{ __('In Progress')}}</div>
                                                    @elseif($project->status == 'on_hold')
                                                    <div class="badge status_badge bg-secondary p-2 px-3 rounded">{{ __('On Hold')}}</div>
                                                    @elseif($project->status == 'Canceled')
                                                    <div class="badge status_badge bg-danger p-2 px-3 rounded"> {{ __('Canceled')}}</div>
                                                    @else
                                                        <div class="badge status_badge bg-warning p-2 px-3 rounded">{{ __('Finished')}}</div>
                                                    @endif
                                                </td>
                                            </tr>
                                     ...
                                     <tbody>
                                           @foreach($project->milestones as $milestone)
                                               ...
                                               <td> @if($milestone->status == 'complete')
                                                                    <label class="status_badge badge bg-success p-2 px-3 rounded">{{__('Complete')}}</label>
                                                                @else
                                                       <label class="status_badge badge bg-warning p-2 px-3 rounded">{{__('Incomplete')}}</label>
                                                   @endif</td>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    @if($task->users()->count() > 0)
                                                            ...
                                                            @foreach($users as $key => $user)
                                                                @if($key<3)
                                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                                        <img src="{{$user->getImgImageAttribute()}}" title="{{ $user->name }}" alt="avtar-image">
                                                                    </a>
                                                                @else
                                                                    @break
                                                                @endif
                                                        ...
                                                        @if(count($users) > 3)
                                                            <a href="#" class="avatar rounded-circle avatar-sm">
                                                                <img src="{{$user->getImgImageAttribute()}}" alt="avtar-image">
                                                            </a>
                                                        @endif
                                                    @else
                                                        {{ __('-') }}
