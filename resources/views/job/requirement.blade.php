...
if(isset($setting['color_flag']) && $setting['color_flag'] == 'true')
{
    ...
    // Get company logo like admin menu
            ...
            <section class="job-banner">
                ...
                <div class="container">
                    <div class="job-banner-content text-center">
                        <h1 class="mb-3" style="color: #ffffff !important; text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
                            {{ __(' We help') }} <br> {{ __('businesses grow') }}
                        </h1>
                        <p style="color: #ffffff !important; text-shadow: 1px 1px 3px rgba(0,0,0,0.8);">{{ __('Work there. Find the dream job youve always wanted..') }}</p>
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div class="apply-job-wrapper bg-light">
                        <div class="section-title text-center">
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mb-4">
                                ...
                                <button type="button" class="btn btn-outline-primary rounded" onclick="shareJobUrl()" title="{{ __('Share this job') }}">
                                    <i class="ti ti-share"></i> {{ __('Share') }}
                                </button>
                            </div>
                            
                            <script>
                                function shareJobUrl() {
