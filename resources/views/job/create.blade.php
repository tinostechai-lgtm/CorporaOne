...
@endsection
@section('content')
    {{Form::open(array('url'=>'job','method'=>'post', 'class'=>'needs-validation', 'novalidate'))}}
    <div class="row mt-3">
        <div class="col-md-6 ">
                ...
                <div class="card-body job-create ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::number('position', old('positions'), ['class' => 'form-control','required' => 'required', 'placeholder'=>__('Enter Positions')]) !!}
                        </div>
                        <div class="form-group col-md-6">
                ...
                <div class="card-body" style="height: 440px">
                    <div class="row ">
                        <div class="form-group col-6 mb-2">
                            {!! Form::label('requirement', __('Job Requirement'),['class'=>'form-label' , 'placeholder'=>__('Enter Job Requirement'),'required' => 'required' ]) !!}<x-required></x-required>
                        </div>
