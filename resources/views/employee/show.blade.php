                ...
                <ul class="list-unstyled mb-0 m-2">
                    <li class="dropdown dash-h-item status-drp">
                        ...
                        <div class="dropdown-menu dash-h-dropdown">
                            <a href="{{route('joiningletter.download.pdf',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('PDF')}}</a>
                            <a href="{{route('joiningletter.download.doc',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('DOC')}}</a>
                        </div>
                    </li>
                </ul>
                <ul class="list-unstyled mb-0 m-2">
                    <li class="dropdown dash-h-item status-drp">
                        ...
                        <div class="dropdown-menu dash-h-dropdown">
                            <a href="{{route('exp.download.pdf',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('PDF')}}</a>
                            <a href="{{route('exp.download.doc',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('DOC')}}</a>
                        </div>
                    </li>
                </ul>
                <ul class="list-unstyled mb-0 m-2">
                    <li class="dropdown dash-h-item status-drp">
                        ...
                        <div class="dropdown-menu dash-h-dropdown">
                            <a href="{{route('noc.download.pdf',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('PDF')}}</a>
                            <a href="{{route('noc.download.doc',$employee->id)}}" class="btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" target="_blank" download=""><i class="ti ti-download"> </i>{{__('DOC')}}</a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="card">
                            <div class="card-body employee-detail-body fulls-card">
                                ...
                                <div class="row">
                                    @php
                                        $employeeDocuments = \App\Models\EmployeeDocument::where('employee_id', $employee->employee_id)->get();
                                    @endphp
                                    @if(!$employeeDocuments->isEmpty())
                                        @foreach($employeeDocuments as $employeeDocument)
                                            @php
                                                $document = \App\Models\Document::find($employeeDocument->document_id);
                                            @endphp
                                            @if($document)
                                                <div class="col-md-6">
                                                    <div class="info text-sm">
                                                        ...
                                                        <span>
                                                            <a href="{{ route('employee.document.download', $employeeDocument->id) }}">{{ $employeeDocument->document_value }}</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            @endif
