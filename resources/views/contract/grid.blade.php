                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <span class="badge status_badge bg-secondary p-2 px-3 rounded">{{ !empty($contract->types)?$contract->types->name:'' }}</span>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <span class="badge status_badge bg-secondary p-2 px-3 rounded">{{ \Auth::user()->priceFormat($contract->value) }}</span>
                                    </div>
                                </div>
                            </li>
