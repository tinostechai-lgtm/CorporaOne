{{ Form::open(array('method'=>'post', 'enctype' => "multipart/form-data", 'class' => 'needs-validation', 'novalidate', 'id' => 'upload_form')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                ...
                <input type="hidden" class="form-control" name="table" id="table" value="customers">
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <a href="" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Customers CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
