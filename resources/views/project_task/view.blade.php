                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto actions">
                                        <div class="action-btn me-2">
                                            <a href="{{asset(Storage::url('tasks/'.$file->file))}}" download class="mx-3 btn btn-sm  align-items-center  bg-secondary" role="button" data-bs-toggle="tooltip" title="{{__('Download')}}">
