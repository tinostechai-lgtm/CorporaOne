    ...
    <script>
        ...
        (function () {
            var chartBarOptions = {
                series: [
                    {
                        name: "{{__('Income')}}",
                        data: {!! isset($incExpLineChartData['income']) ? json_encode($incExpLineChartData['income']) : '[]' !!}
                    },
                    {
                        name: "{{__('Expense')}}",
                        data: {!! isset($incExpLineChartData['expense']) ? json_encode($incExpLineChartData['expense']) : '[]' !!}
                    }
                ],
                ...
                xaxis: {
                    categories: {!! isset($incExpLineChartData['day']) ? json_encode($incExpLineChartData['day']) : '[]' !!},
                    title: {
                        text: '{{ __("Date") }}'
                    }
                },
        ...
        (function () {
            var options = {
                ...
                series: [{
                    name: "{{__('Income')}}",
                    data: {!! isset($incExpBarChartData['income']) ? json_encode($incExpBarChartData['income']) : '[]' !!}
                }, {
                    name: "{{__('Expense')}}",
                    data: {!! isset($incExpBarChartData['expense']) ? json_encode($incExpBarChartData['expense']) : '[]' !!}
                }],
                xaxis: {
                    categories: {!! isset($incExpBarChartData['month']) ? json_encode($incExpBarChartData['month']) : '[]' !!},
                },
        ...
        (function () {
            var options = {
                ...
                series: {!! isset($expenseCatAmount) ? json_encode($expenseCatAmount) : '[]' !!},
                colors: {!! isset($expenseCategoryColor) ? json_encode($expenseCategoryColor) : '[]' !!},
                labels: {!! isset($expenseCategory) ? json_encode($expenseCategory) : '[]' !!},
                legend: {
                    show: true
                }
            };
        ...
        (function () {
            var options = {
                ...
                series: {!! isset($incomeCatAmount) ? json_encode($incomeCatAmount) : '[]' !!},
                colors: {!! isset($incomeCategoryColor) ? json_encode($incomeCategoryColor) : '[]' !!},
                labels: {!! isset($incomeCategory) ? json_encode($incomeCategory) : '[]' !!},
                legend: {
                    show: true
                }
            };
        ...
        (function () {
            var options = {
                series: [{{ isset($storage_limit) ? round($storage_limit, 2) : 0 }}],
                chart: {
                    height: 400,
                    type: 'radialBar',
                    offsetY: -20,
        ...
        // ============================================================
        // ✅ FIXED: Calendar AJAX - Uses direct URL instead of route name
        // ============================================================
        ...
        function get_data() {
            ...
            $.ajax({
                // ✅ FIXED: Using direct URL instead of route('event.get_data')
                ...
                error: function(xhr) {
                    console.log('Error loading calendar events:', xhr);
                }
            });
        }
    </script>
                                ...
                                <table class="table">
                                    ...
                                    @forelse($bankAccountDetail ?? [] as $bankAccount)
                                        <tr class="font-style">
                                            ...
                                            <td>{{\Auth::user()->priceFormat($bankAccount->opening_balance ?? 0)}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>{{__('Income & Expense')}}
                                <span class="float-end text-muted">{{__('Current Year').' - '.($currentYear ?? date('Y'))}}</span>
                            </h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card" style="height: 315px">
                        <div class="card-header">
                            <h5>{{__('Income By Category')}}
                                <span class="float-end text-muted">{{__('Year').' - '.($currentYear ?? date('Y'))}}</span>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    @forelse($latestIncome ?? [] as $income)
                                        <tr>
                                            ...
                                            <td>{{\Auth::user()->priceFormat($income->amount ?? 0)}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4">
                                ...
                                <table class="table">
                                    ...
                                    @forelse($latestExpense ?? [] as $expense)
                                        <tr>
                                            ...
                                            <td>{{\Auth::user()->priceFormat($expense->amount ?? 0)}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4">
                        ...
                        <div class="card-header">
                            <h5>{{__('Storage Limit')}}
                                <small class="float-end text-muted">
                                    {{ isset($users) ? ($users->storage_limit ?? 0) . 'MB' : '0MB' }} / 
                                    {{ isset($plan) ? ($plan->storage_limit ?? 0) . 'MB' : '0MB' }}
                                </small>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    @forelse($recentInvoice ?? [] as $invoice)
                                        <tr>
                                            ...
                                            <td>{{\Auth::user()->priceFormat($invoice->getTotal() ?? 0)}}</td>
                                            <td>
                                                @if(isset($invoice->status))
                                                    @switch($invoice->status)
                                                        @case(0)
                                                            <span class="p-2 px-3 rounded badge status_badge bg-secondary">{{ __(\App\Models\Invoice::$statues[$invoice->status] ?? 'Draft') }}</span>
                                                            @break
                                                        @case(1)
                                                            <span class="p-2 px-3 rounded badge status_badge bg-warning">{{ __(\App\Models\Invoice::$statues[$invoice->status] ?? 'Sent') }}</span>
                                                            @break
                                                        @case(2)
                                                            <span class="p-2 px-3 rounded badge status_badge bg-danger">{{ __(\App\Models\Invoice::$statues[$invoice->status] ?? 'Unpaid') }}</span>
                                                            @break
                                                        @case(3)
                                                            <span class="p-2 px-3 rounded badge status_badge bg-info">{{ __(\App\Models\Invoice::$statues[$invoice->status] ?? 'Partial') }}</span>
                                                            @break
                                                        @case(4)
                                                            <span class="p-2 px-3 rounded badge status_badge bg-primary">{{ __(\App\Models\Invoice::$statues[$invoice->status] ?? 'Paid') }}</span>
                                                            @break
                                                        @default
                                                            <span class="p-2 px-3 rounded badge status_badge bg-secondary">{{ __('Unknown') }}</span>
                                                    @endswitch
                                                @endif
                                            </td>
                                        </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyInvoice['invoiceTotal'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyInvoice['invoicePaid'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyInvoice['invoiceDue'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyInvoice['invoiceTotal'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyInvoice['invoicePaid'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyInvoice['invoiceDue'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <table class="table">
                                    ...
                                    @forelse($recentBill ?? [] as $bill)
                                        <tr>
                                            ...
                                            <td>{{\Auth::user()->priceFormat($bill->getTotal() ?? 0)}}</td>
                                            <td>
                                                @if(isset($bill->status))
                                                    @switch($bill->status)
                                                        @case(0)
                                                            <span class="p-2 px-3 status_badge rounded badge bg-secondary">{{ __(\App\Models\Bill::$statues[$bill->status] ?? 'Draft') }}</span>
                                                            @break
                                                        @case(1)
                                                            <span class="p-2 px-3 status_badge rounded badge bg-warning">{{ __(\App\Models\Bill::$statues[$bill->status] ?? 'Sent') }}</span>
                                                            @break
                                                        @case(2)
                                                            <span class="p-2 px-3 status_badge rounded badge bg-danger">{{ __(\App\Models\Bill::$statues[$bill->status] ?? 'Unpaid') }}</span>
                                                            @break
                                                        @case(3)
                                                            <span class="p-2 px-3 status_badge rounded badge bg-info">{{ __(\App\Models\Bill::$statues[$bill->status] ?? 'Partial') }}</span>
                                                            @break
                                                        @case(4)
                                                            <span class="p-2 px-3 status_badge rounded badge bg-primary">{{ __(\App\Models\Bill::$statues[$bill->status] ?? 'Paid') }}</span>
                                                            @break
                                                        @default
                                                            <span class="p-2 px-3 status_badge rounded badge bg-secondary">{{ __('Unknown') }}</span>
                                                    @endswitch
                                                @endif
                                            </td>
                                        </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyBill['billTotal'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyBill['billPaid'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($weeklyBill['billDue'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyBill['billTotal'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyBill['billPaid'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h4 class="text-muted">{{\Auth::user()->priceFormat($monthlyBill['billDue'] ?? 0)}}</h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="card-body">
                            @forelse($goals ?? [] as $goal)
                                @php
                                    ...
                                    $per = number_format($percentage, Utility::getValByName('decimal_number') ?? 0, '.', '');
                                @endphp
                                                ...
                                                <span>
                                                    <span class="row align-items-center">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-3 mb-sm-0">{{ __(\App\Models\Goal::$goalType[$goal->type] ?? $goal->type) }}</h6>
                                                        </span>
                                                        <span class="col">
