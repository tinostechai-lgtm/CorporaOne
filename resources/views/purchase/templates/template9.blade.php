...
<body>
    ...
    <div class="purchase-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
        ...
        <div class="purchase-body" style="padding-right: 0;">
            <table class="add-border purchase-summary">
