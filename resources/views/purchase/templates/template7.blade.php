...
<body>
    <div class="purchase-preview-main" id="boxes">
        <div class="purchase-header" style="border-top: 15px solid var(--theme-color); background: #f8f8f8;">
            <table>
                <tbody>
                    <tr>
                        <td>
                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::purchaseNumberFormat($settings, $purchase->purchase_id) }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Purchase Date') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $purchase->purchase_date) }}</td>
                                    </tr>
                                    ...
                                    @if (!empty($customFields) && count($purchase->customField) > 0)
                                        @foreach ($customFields as $field)
                                            <tr>
                                                <td>{{ $field->name }} :</td>
                                                <td> {{ !empty($purchase->customField) ? $purchase->customField[$field->id] : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
        ...
        <div class="purchase-body" style="border-bottom: 15px solid var(--theme-color);">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td>{{ __('Total') }}:</td>
                                    <td>{{ Utility::priceFormat($settings, $purchase->getSubTotal() - $purchase->getTotalDiscount() + $purchase->getTotalTax()) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('Paid') }}:</td>
                                    <td>{{ Utility::priceFormat($settings, $purchase->getTotal() - $purchase->getDue()) }}
                                    </td>
                                </tr>
