    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                @if($page['menubar_page_name'] == 'Terms and Conditions' || $page['menubar_page_name'] == 'Privacy Policy')
                {{ Form::text('menubar_page_name', $page['menubar_page_name'], ['class' => 'form-control font-style', 'placeholder' => __('Enter Plan Name'), 'required' => 'required', 'readonly' => 'readonly']) }}
                @else
