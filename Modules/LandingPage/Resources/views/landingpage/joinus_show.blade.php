                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>{{ __('Email') }}</th> <!-- Fixed typo: __Name -> __('Email') -->
                                            <th>{{ __('Name') }}</th>
                                            <th>{{ __('Phone') }}</th> <!-- Added Phone column -->
                                            <th>{{ __('Action') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action-btn me-2">
                                                            <a href="{{ route('join_us.show', $value->id) }}" class="btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="{{ __('View') }}">
