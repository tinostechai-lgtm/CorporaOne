        ...
        2: [function(require, module, exports) {
            ...
            class o {
                ...
                export (e) {
                    ...
                    if (o.type) {
                        if ("txt" !== o.type && "csv" !== o.type || (i[0] = this.header), o.selection)
                            if (isNaN(o.selection)) {
                                if (Array.isArray(o.selection))
                                    for (n = 0; n < o.selection.length; n++) i = i.concat(this.pages[o.selection[n] - 1])
                            ...
                            if ("txt" === o.type || "csv" === o.type) {
                                for (h = "", n = 0; n < i.length; n++) {
                                    for (r = 0; r < i[n].cells.length; r++)
                                        if (!o.skipColumn.includes(s[r].originalCellIndex) && this.columns(s[r].originalCellIndex).visible()) {
                                ...
                                for (r = 0; r < i.length; r++)
                                    for (a[r] = a[r] || {}, n = 0; n < s.length; n++) !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (a[r][s[n].textContent] = i[r].cells[n].textContent);
