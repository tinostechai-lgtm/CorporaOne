...
use App\Models\FreeTrialSubscription;
...
class DashboardController extends Controller
{
    ...
    public function landingPage()
    {
        ...
        if ($adminSettings['display_landing_page'] == 'on'/*  && \Schema::hasTable('landing_page_settings') */) {
            ...
            return view('landingpage::layouts.landingpage' , compact('adminSettings', 'testimonials', 'faqs'));
    ...
    //         'email' => 'required|email|unique:free_trial_subscriptions,email',
    //     ]);
    ...
    //     FreeTrialSubscription::create(['email' => $request->email]);

    //     return redirect()->back()->with('success', 'You have successfully subscribed for the free trial!');
    // }
    // public function viewSubscribers()
    // {
    //     $subscribers = FreeTrialSubscription::latest()->paginate(10);
