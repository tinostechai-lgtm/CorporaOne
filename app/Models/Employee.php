...
class Employee extends Model
{
   protected $fillable = [
    ...
    'salary_type',
    'biometric_emp_id',
    'face_descriptor',           // ← ADD THIS LINE
    'account',
    'salary',
    'created_by',
    'half_day_threshold',
    'enable_half_day',
    'late_grace_period',        // How many minutes late allowed (e.g., 60 = 1 hour)
    'enable_late_marking',      // Enable/disable late marking
    'late_access_enabled',      // NEW: Whether employee has late entry access
